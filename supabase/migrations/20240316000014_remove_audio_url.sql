-- Remove audio_url column (replaced by audio_word)
alter table public.vocabulary drop column if exists audio_url;

-- Update get_active_pool: remove audio_url from return
...
-- Update check_refill_needed: use audio_word only
