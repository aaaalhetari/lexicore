-- Fix: One cycle per word per day — exclude words that completed any cycle today
-- Previously: completing cycle 1 set cycle=2, word reappeared same session (cycle_2_completed_date null)
-- Now: exclude if cycle_1/2/3_completed_date = today (done for the day)
