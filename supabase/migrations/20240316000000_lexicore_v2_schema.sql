...
create index vocabulary_user_learning_idx on public.vocabulary (user_id, status, cycle, stage)
  where status = 'learning';
create index vocabulary_user_waiting_idx on public.vocabulary (user_id)
...
create index refill_jobs_pending_idx on public.refill_jobs (status)
