...
-- Fixes: 1) Duplicate vocabulary, 2) One cycle per day logic

-- Step 1: Remove duplicate vocabulary (keep row with highest progress)
...
-- Step 3: One cycle per word per day — exclude words that completed any cycle today
